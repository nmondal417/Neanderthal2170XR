...
//
// On Mon May 15 01:21:39 EDT 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkpipelined(CLK,
  ...
  // value method getPC
  assign getPC = program_counter_register ;
  ...
  assign IF_fromImem_want_enq2_readBeforeLaterWrites_0__ETC___d4249 =
	     fromImem_want_enq2_readBeforeLaterWrites_0$Q_OUT ?
	       { getIResp_a[100:97], x_addr__h191723, getIResp_a[31:0] } :
	       fromImem_want_enq2_register[67:0] ;
  ...
  assign x_addr__h191723 = getIResp_a[96:65] + 32'd4 ;
  ...
  begin
	...
	starting <= `BSV_ASSIGNMENT_DELAY 1'd0;
